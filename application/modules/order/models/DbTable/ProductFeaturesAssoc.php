...
/**
 * Tabela que associa produtos a suas características.
 *
 * @category   SimpleShoppingCart
 * @package    Order_Model
 * @subpackage Order_Model_DbTable
 ...
 * @license    BSD 3-Clause license
 */
class Order_Model_DbTable_ProductFeaturesAssoc extends STLib_Model_DbTable_PrefixedDbTable
{
    /**
     ...
     * @var string
     */
    protected $_name = 'product_features_assoc';
    ...
    protected $_referenceMap = array(
        ...
        'Feature' => array(
            'columns'       => 'feature_id',
            'refTableClass' => 'Order_Model_DbTable_ProductFeatures',
            'refColumns'    => 'id',
            'onDelete'      => self::RESTRICT,
            'onUpdate'      => self::RESTRICT
        )
