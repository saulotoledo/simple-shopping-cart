 ...
 * @license    BSD 3-Clause license
 */
class Order_Model_DbTable_ProductFeatures extends STLib_Model_DbTable_PrefixedDbTable
{
    /**
     ...
     * @var string
     */
    protected $_name = 'product_features';
     ...
     * @var array
     */
    protected $_dependentTables = array("Order_Model_DbTable_ProductFeaturesAssoc");
}
